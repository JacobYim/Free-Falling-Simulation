class main_particle{
  ...
  class free_particle{
    constructor(width, height, g, dt, mass, r, T, k, mp, position, vwx, vwy){
      ...
      // var radian=random(0,360)*(TWO_PI/360);


      // this.v = sqrt(3*this.k*this.T/(this.mass));
      // this.vx = this.v*cos(radian);
      // this.vy = this.v*sin(radian);
